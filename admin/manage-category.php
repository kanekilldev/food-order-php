                ...
                <table class="tbl-full">
                    ...
                    <?php 
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo SITEURL; ?>admin/delete-category.php?id=<?php echo $id; ?>&image_name=<?php echo $image_name; ?>" class="btn-danger">Xoá</a>
                                        </td>
                                    </tr>
                        ...
                        else
                        {
                            ...
                            <tr>
                                <td colspan="6"><div class="error">Không có danh mục nào được thêm vào</div></td>
                            </tr>
