        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <table class="tbl-30">
                ...
                <tr>
                    <td>Active: </td>
                    <td>
                        <input <?php if($active=="Hiển thị "){echo "checked";} ?> type="radio" name="active" value="Hiển thị "> Hiển thị 

                        <input <?php if($active=="Ẩn"){echo "checked";} ?> type="radio" name="active" value="Ẩn"> Ẩn 
                    </td>
                </tr>
